...
export function ComingSoonModal({ isOpen, onClose, feature }: ComingSoonModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[2300]" />
      <DialogContent className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#0a0a2e] border border-[#1a1a40] text-white rounded-2xl z-[2300] max-w-sm mx-auto p-6">
