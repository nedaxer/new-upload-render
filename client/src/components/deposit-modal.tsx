...
export function DepositModal({ isOpen, onClose, onSelectMethod }: DepositModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[50000]">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0a0a2e] border-t border-[#1a1a40] text-white rounded-t-2xl animate-slide-up max-h-[70vh] overflow-y-auto z-[50000]"
           style={{
