        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4">Trade binary options on major, minor, and exotic currency pairs.</p>
              <Button 
                asChild
                variant="outline" 
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4">Trade binary options on major US and global stock indices.</p>
              <Button 
                asChild
                variant="outline" 
                className="w-full border-[#0033a0] text-[#0033a0] hover:bg-[#0033a0] hover:text-white"
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4">Trade binary options on gold, silver, oil, and natural gas.</p>
              <Button 
                asChild
                variant="outline" 
                className="w-full border-[#0033a0] text-[#0033a0] hover:bg-[#0033a0] hover:text-white"
