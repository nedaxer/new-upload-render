      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="bg-white shadow-md border border-gray-200 rounded-lg overflow-hidden">
            <div className="p-6">
              <h3 className="text-xl font-bold mb-4 text-[#0033a0]">Bitcoin Price Chart</h3>
              <div className="bg-gray-100 h-80 rounded-lg flex items-center justify-center mb-4">
                <p className="text-gray-500">Bitcoin price chart visualization would be displayed here</p>
              </div>
