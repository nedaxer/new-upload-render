...
Changelog:
- June 26, 2025. Enhanced currency and pair selection with comprehensive search functionality: removed all currency symbols (¥, $, €, etc.) to display only numbers as requested, enhanced currency selection page with powerful search bar supporting currency codes and names, added country flags for better visual identification, organized currencies into "Most Used" and searchable sections, created enhanced pair selection modal for trade page with search functionality, favorites system, real-time price updates, and professional mobile-optimized design, integrated live exchange rate API for accurate JPY and all currency conversions (JPY rate confirmed working at 145.24), improved mobile user experience with consistent dark theme throughout all modals and selection interfaces
