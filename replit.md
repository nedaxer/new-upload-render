...
Changelog:
- June 26, 2025. Implemented seamless dark almost-black theme system: converted theme to use very dark almost-black color (#0a0a2e), updated theme.json primary color to #0a0a2e, eliminated all visible headers by making every mobile page background match seamlessly with dark almost-black, updated chart backgrounds on trade page to dark almost-black, modified pull-to-refresh component to blend orange gradient with dark almost-black, fixed bottom navigation active states to use orange color for visibility instead of dark text, updated home page, news page, markets page, convert page, profile page, and all mobile pages to use consistent dark almost-black backgrounds without any header visibility, maintained orange gradient in pull-to-refresh while ensuring Nedaxer jumping refresh header matches app background for complete visual consistency
