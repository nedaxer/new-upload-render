...
Changelog:
- June 25, 2025. Completely rebuilt admin system: recreated admin login with case-insensitive authentication (nedaxer.us@gmail.com / Nedaxer.us), implemented hardcoded admin bypass for reliable access, rebuilt admin dashboard with modern UI featuring user search, fund management, and account deletion, fixed all authentication and session management issues, admin system now fully operational with mobile-friendly interface and proper MongoDB integration
