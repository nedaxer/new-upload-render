...
Changelog:
- June 24, 2025. Enhanced pull-to-refresh with CD-like logo animation: implemented 3D rotation effect where logo spins like a CD coming out (-180° to 0° rotation), added black-to-slate gradient transition for smooth merging between refresh header and main app content, removed jumping Nedaxer letters during refresh replacing with clean loading spinner, updated Nedaxer header background to match app's slate color scheme, created seamless visual flow from black refresh area to app interface
