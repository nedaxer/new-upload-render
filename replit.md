...
Changelog:
- June 24, 2025. Fixed news images for all sources: enhanced RSS parser with custom field mapping for media content, implemented source-specific image extraction for CryptoSlate, BeInCrypto, Google News, CoinDesk, and CryptoBriefing, added robust fallback handling with branded source icons, improved image URL processing for relative paths and protocol handling, news articles now display proper images or attractive source-branded placeholders
