...
Changelog:
- June 24, 2025. Refined pull-to-refresh animation with smaller elements: reduced NEDAXER letter size to very small (h-8), decreased header height to compact size (120px), made refresh logo smaller (70% of header), shortened refresh duration to 3 seconds, implemented smooth bounce animations with reduced jump height for better mobile experience
