...
Changelog:
- June 24, 2025. Enhanced pull-to-refresh animation with proper sizing: made NEDAXER letters extremely small (h-4), increased header to large size (200px), made NEDAXER logo very big (90% of header), implemented page scrolling effect during pull-down, restored 5-second refresh duration, created smooth content translation for native mobile feel
