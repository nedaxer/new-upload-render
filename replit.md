...
Changelog:
- June 26, 2025. Implemented dark almost-black theme system: converted theme to use very dark almost-black color (#0a0a2e), updated theme.json primary color to #0a0a2e, changed all mobile app backgrounds and UI elements to use dark almost-black theme, updated chart backgrounds on trade page to dark almost-black, modified pull-to-refresh component to blend orange gradient with dark almost-black instead of gray colors, updated bottom navigation active states and header colors to use dark almost-black, maintained orange gradient in pull-to-refresh while replacing gray sections with dark almost-black for sophisticated almost-black branding throughout mobile application
