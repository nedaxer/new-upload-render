...
Changelog:
- June 26, 2025. Enhanced splash screen timing and messaging: reduced splash screen duration from 4 seconds to 2 seconds for faster app startup, improved welcome message from simple "Thanks for choosing Nedaxer" to professional two-line message "Welcome to the future of trading" with "Thank you for choosing Nedaxer" subtitle, adjusted internal timing for smoother animation flow with letters arranging in 0.8s and logo appearing at 1.3s, created more engaging user experience with enhanced visual hierarchy using different font weights and opacity levels
