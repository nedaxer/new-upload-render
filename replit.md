...
Changelog:
- June 26, 2025. Implemented Midnight Blue theme system: converted theme context from ultramarine to Midnight Blue (#191970), updated theme.json primary color to #191970, changed all mobile app backgrounds and UI elements to use Midnight Blue, updated chart backgrounds on trade page to Midnight Blue, modified pull-to-refresh component to blend orange gradient with Midnight Blue instead of gray colors, updated bottom navigation active states and header colors to use Midnight Blue, maintained orange gradient in pull-to-refresh while replacing gray sections with Midnight Blue for consistent branding
