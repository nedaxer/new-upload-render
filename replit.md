...
Changelog:
- June 25, 2025. Completely rebuilt clean admin portal system: removed all previous admin components and hardcoded users, created fresh admin portal at /admin-portal with modern gradient design, implemented new authentication (admin@nedaxer.com / NedaxerAdmin2025), added comprehensive user search by email/UID, integrated fund management with user notifications, built secure account deletion, designed mobile-friendly interface with glassmorphism effects, fixed all MongoDB integration issues
