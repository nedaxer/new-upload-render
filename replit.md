...
- June 26, 2025. Fixed infinite loading issue for new user registration and login: enhanced authentication state management in MobileAppLoader with proper query invalidation, added emergency timeouts to prevent infinite loading, implemented proper auth state synchronization after successful registration/login, removed "Nedaxer" branding text from startup animation and made all loading elements smaller per user request
