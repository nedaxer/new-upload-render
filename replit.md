...
Changelog:
- June 24, 2025. Redesigned pull-to-refresh with proper mobile behavior: removed initial NEDAXER letters during pull-down, created separate small NEDAXER header (60px) for refresh state, implemented fixed positioning for proper page scrolling effect, made content translate down naturally as user pulls, separated logo header from refresh header for better UX, enhanced mobile-first pull-to-refresh implementation
