...
Changelog:
- June 26, 2025. Made Nedaxer launch animation smaller and cleaner: reduced letter sizes by 50% (from w-24 to w-12), reduced final logo size by 50% (from w-80 to w-40), removed orange loading line completely, removed "Cryptocurrency Trading Platform" subtitle text, removed animated loading dots and progress bar for minimalist splash screen
